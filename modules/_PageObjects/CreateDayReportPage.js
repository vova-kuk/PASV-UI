...
class CreateDayReportPage extends AppPage {
    ...
    get understoodEverything() {
        return browser.$('//input[@id="input-1"]') && browser.$('//input[@label="I understood everything"]');
    }
    ...
    get interviewPreparation() {
        return browser.$('//input[@id="input-7"]') && browser.$('//input[@label="Interview preparation"]');
    }

    get recruiterPhoneCall() {
        return browser.$('//input[@id="input-8"]') && browser.$('//input[@label="Recruiter phone call"]');
    }

    get interviewTechScreen() {
        return browser.$('//input[@id="input-9"]') && browser.$('//input[@label="Interview technical screen"]');
    }
    ...
    get instructionToUnderstoodEverything2() {
        return browser.$('//div[@innertext="It means that you are not experiencing difficulties and understand the material that is discussed in the lessons."]');
    }
